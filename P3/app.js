$(function() {
    let baseURL = "https://pokeapi.com/api/v2";
    ...
    async function part2() {
        let allData = await $.getJSON(`${baseURL}/pokemon/?limit1000`);
    ...
    // Instead of relying on console.log, let’s create a UI for these random pokemon. Build an HTML page that lets you click on a button to generate data from three randomly chosen pokemon. Include the name of the pokemon, an image of the pokemon, and the description of its species which you found in 3.
    let $btn = $("button");
    ...
    $btn.on("click", async function() {
        ...
        speciesData.forEach((d, i) => {
            ...
            let name = randomPokemonData[i].name;
